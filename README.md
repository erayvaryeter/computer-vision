...
Building OpenCV/4.5.0 with correct configuration:
  ...
  - Run the command: conan create . opencv/4.8.1@ -s build_type=Debug -o opencv:contrib=True -o opencv:nonfree=True -o opencv:with_tesseract=False
  - Run the command: conan create . opencv/4.8.1@ -s build_type=Release -o opencv:contrib=True -o opencv:nonfree=True -o opencv:with_tesseract=False
...
If you have NVIDIA CUDA enabled GPU, you can create OpenCV package with CUDA support, which will result in a lot faster execution of the applications:
  - Run the command: conan create . opencv/4.8.1@ -s build_type=Debug -o opencv:contrib=True -o opencv:nonfree=True -o opencv:with_tesseract=False -o opencv:with_cuda=True -o opencv:with_cudnn=True -o opencv:dnn_cuda=True -o opencv:with_cublas=True
  - Run the command: conan create . opencv/4.8.1@ -s build_type=Release -o opencv:contrib=True -o opencv:nonfree=True -o opencv:with_tesseract=False -o opencv:with_cuda=True -o opencv:with_cudnn=True -o opencv:dnn_cuda=True -o opencv:with_cublas=True
