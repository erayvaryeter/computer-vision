...
public:
	...
	// BRISK
	void ApplyBriskTrain(int numComponents, int thresh = 30, int octaves = 3, float patternScale = 1.0f);
	void ApplyBriskTest(int numComponents, int thresh = 30, int octaves = 3, float patternScale = 1.0f);
